    ...
    $(function(){
        $('.nv li:nth-of-type(1)').click(function(){
            ...
            $('.changebox7').css("opacity", "0");
            $('.changebox8').css("opacity", "0");
        })
        ...
        $('.nv li:nth-of-type(7)').click(function(){
            $('.changebox7').css("opacity", "1");
            $('.changebox1').css("opacity", "0");
            $('.changebox2').css("opacity", "0");
            $('.changebox3').css("opacity", "0");
            $('.changebox4').css("opacity", "0");
        ...
        $('.nv li:nth-of-type(8)').click(function(){
            $('.changebox8').css("opacity", "1");
            $('.changebox1').css("opacity", "0");
            $('.changebox2').css("opacity", "0");
            $('.changebox3').css("opacity", "0");
            $('.changebox4').css("opacity", "0");
